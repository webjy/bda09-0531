        ...
        e.exports = function (e,isListen) {
            ...
            try {
                var t = "",
                    ...
                    d = e.preload,
                    p = e.url;
                if((!localStorage.playerType || localStorage.playerType == 'ttx') && !isListen){
                    p = '';
                    // return t += '<div class="dplayer-video ', r && (t += "dplayer-video-current"), t += '"\n    webkit-playsinline\n    playsinline\n    ', i && (t += 'poster="', t += l(i), t += '"'), t += "\n    ", (s || a) && (t += 'crossorigin="anonymous"'), t += "\n    ", d && (t += 'preload="', t += l(d), t += '"'), t += "\n    ", p && (t += 'src="', t += l(p), t += '"'), t += "\n    >\n    ", a && (t += '\n    <track kind="metadata" default src="', t += l(o.url), t += '"></track>'), t += "</div>"
                }
            } catch (e) {
            ...
            return t = e, (a = [{
                ...
                key: "initloadingChecker", value: function () {
                    ...
                    this.loadingChecker = setInterval((function () {
                        e.enableloadingChecker && (a = e.player.video.currentTime, n || a !== t || e.player.video.paused || (e.player.container.classList.add("dplayer-loading-1"), n = !0), n && a > t && !e.player.video.paused && (e.player.container.classList.remove("dplayer-loading-1"), n = !1), t = a)
                    }), 100)
                }
            }, {
        ...
        var Se = function () {
            ...
            return t = e, (a = [{
                key: "show", value: function (e, t) {
                    if(!this.player.options.contextmenu || this.player.options.contextmenu.length == 0){
                        return
                    }
        ...
        var Ce = 0,
            ...
            Fe = function () {
                ...
                return t = e, o = [{
                    ...
                    key: "play", value: function () {
                        try {
                            if(localStorage.playerType == 'ttx' && !this.options.isListen){
                                return
                            }
                        } catch (e) {
                    ...
                    key: "pause", value: function () {
                        this.paused = !0, this.container.classList.remove("dplayer-loading-1"), this.video.paused || this.bezel.switch(U.pause), this.template.playButton.innerHTML = U.play, this.video.pause(), this.timer.disable("loading"), this.container.classList.remove("dplayer-playing"), this.container.classList.add("dplayer-paused"), this.danmaku && this.danmaku.pause()
                    }
                }, {
                    ...
                    key: "volume", value: function (e, t, a) {
                        try {
                            if(localStorage.playerType == 'ttx'){
                                return 0
                            }
                        } catch (e) {
                            ...
                            case "webtorrent":
                                if (WebTorrent)
                                    if (WebTorrent.WEBRTC_SUPPORT) {
                                        this.container.classList.add("dplayer-loading-1");
                                        ...
                                        e.src = "", e.preload = "metadata", e.addEventListener("durationchange", (function () {
                                            return a.container.classList.remove("dplayer-loading-1")
